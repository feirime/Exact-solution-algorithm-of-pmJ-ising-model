...
Вычисления CUDA проводились на GPU A100 в соотношении одна решетка -- один GPU. OpenMP и numba, а так же все однопоточные вычисления проводились на \textbf{скопировать описание кластера}
