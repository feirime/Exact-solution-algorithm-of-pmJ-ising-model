...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|c|}
		...
		\hline
		Python (один поток) & 20.8  & 454   & 7232   & ---    & ---    & ---     & --- \\ 
		\hline
		Python (+Numba)     & 4.2 & 5.62    & 17.74   & 157    & 1611    & ---     & --- \\ 
		\hline
		C (один поток)      & 0.076 & 0.5   & 5.5   & 72.84  & 756    & 7242    & --- \\ 
		\hline
		C (+ OpenMP)        & 0.074 & 0.21  & 0.61  & 3    & 23     & 206     & 2085 \\ 
		\hline
